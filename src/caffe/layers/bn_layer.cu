...
namespace caffe {
  ...
  void BNLayer<Dtype>::Forward_gpu(const vector<Blob<Dtype>*>& bottom,
    ...
    case BNParameter_BNMode_LEARN:
      ...
      // EX across spatial
      caffe_gpu_gemv<Dtype>(CblasNoTrans, N_ * C_, L_ * H_ * W_,
		  Dtype(1. / (L_ * H_ * W_)),
      ...
      caffe_gpu_gemm<Dtype>(CblasNoTrans, CblasNoTrans, N_, C_, 1, Dtype(1),
          ...
          spatial_mean_data);
	  caffe_gpu_gemm<Dtype>(CblasNoTrans, CblasNoTrans, N_ * C_, L_ * H_ * W_,
          1, -Dtype(1),
      ...
      caffe_gpu_gemm<Dtype>(CblasNoTrans, CblasNoTrans, N_, C_, 1, Dtype(1),
          ...
          spatial_mean_data);
	  caffe_gpu_gemm<Dtype>(CblasNoTrans, CblasNoTrans, N_ * C_, L_ * H_ * W_, 1,
          Dtype(1),
          spatial_mean_.gpu_data(), spatial_sum_multiplier_.gpu_data(), Dtype(0),
          buffer_blob_.mutable_gpu_data());
  ...
  void BNLayer<Dtype>::Backward_gpu(const vector<Blob<Dtype>*>& top,
    ...
    case BNParameter_BNMode_LEARN:
      ...
      // EX across spatial
	  caffe_gpu_gemv<Dtype>(CblasNoTrans, N_ * C_, L_ * H_ * W_, Dtype(1),
      ...
      caffe_gpu_gemm<Dtype>(CblasNoTrans, CblasNoTrans, N_, C_, 1, Dtype(1),
          ...
          spatial_mean_data);
      caffe_gpu_gemm<Dtype>(CblasNoTrans, CblasNoTrans, N_ * C_,
		  L_ * H_ * W_, 1, Dtype(1), spatial_mean_.gpu_data(),
          spatial_sum_multiplier_.gpu_data(), Dtype(0),
          bottom_diff);

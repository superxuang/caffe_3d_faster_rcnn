#ifndef CAFFE_ROI_CROP_LAYER_HPP_
#define CAFFE_ROI_CROP_LAYER_HPP_
...
class ROICropLayer : public Layer<Dtype> {
 public:
  explicit ROICropLayer(const LayerParameter& param)
      : Layer<Dtype>(param) {}
  ...
  virtual inline const char* type() const { return "ROICrop"; }
 ...
 protected:
  ...
  int crop_height_;
  int crop_width_;
  Dtype spatial_scale_xy_;
  Dtype spatial_scale_z_;
};

}  // namespace caffe

#endif  // CAFFE_ROI_CROP_LAYER_HPP_

#ifndef CAFFE_MULTI_CHANNEL_DATA_LAYER_HPP_
#define CAFFE_MULTI_CHANNEL_DATA_LAYER_HPP_
...
class MultiChannelDataLayer : public BasePrefetchingDataLayer<Dtype> {
 public:
  typedef itk::Image<Dtype, 3> ImageType;
  typedef itk::Image<char, 3> LabelType;

  explicit MultiChannelDataLayer(const LayerParameter& param)
      : BasePrefetchingDataLayer<Dtype>(param) {}
  virtual ~MultiChannelDataLayer();
...
#endif  // CAFFE_MULTI_CHANNEL_DATA_LAYER_HPP_
